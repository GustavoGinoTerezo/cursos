# EXERCICIO SEMELHANTE AO EXERCICIO 01, PORÉM É UTILIZADO UMA VERIFICAÇÃO EM LISTA PARA SABER A QUANTIDADE EXATA DE DIAS QUE O MÊS POSSUI E VERIFICA SE OS DIAS INFORMADOS PARA AQUELE # MÊS ESTÁ CORRETA, CASO ESTEJA ERRADA, É PRINTADO NO TERMINAL UMA LINHA ESCRITA "FALHA".
